...
function miFuncion(xml) {
  ...
  for (i = 0; i < x.length; i++) {
    ...
    // actualizo la tabla de visualización
      ...
      tabla += "<div class='elwidth'> <div class='elwidth2'><div class='flip-box-front'> <img class='imagen' src='"+xmlFoto +"'><div class='subtitulo'>" + xmlNombre +"</div></div><div class='flip-box-back'><span>" + xmlDetalle + "</span></div></div></div></div>";
